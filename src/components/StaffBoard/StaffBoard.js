...
function StaffBoard({ uid, userName, role }) {
  return (
      ...
      <p>
        <a href={"https://osu.ppy.sh/users/" + uid} target="_blank" class="top-0 relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold shadow text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
