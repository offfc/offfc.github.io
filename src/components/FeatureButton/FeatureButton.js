...
export default function FeatureButton({ link, buttonText, spacing }) {
  return (
    <a
      href={link}
      target="_self"
      className="feature-button relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold shadow text-blueArchive transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group"
